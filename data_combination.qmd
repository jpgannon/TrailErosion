...
All_measurements_long_adj <- All_Measurements_wide |>
  pivot_longer(cols = c(F2021, S2022, F2024, S2025))



write_csv(All_measurements_long_adj, "all_measurements_long.csv")
```
...
Change_at_each_measure <- All_Measurements_wide |>
  mutate(
    F2021_to_S2022 =  S2022 - F2021,
    F2021_to_F2024 =  F2024 - F2021,
    F2021_to_S2025 =  S2025 - F2021,
    S2022_to_F2024 =  F2024 - S2022,
    S2022_to_S2025 =  S2025 - S2022
  )|>
...
diff_at_each_meas <- pivot_longer(Change_at_each_measure, 
                                  cols = -c("Transect", "Measurement_Point"))



write_csv(diff_at_each_meas, "diff_at_each_measurement.csv")
```
